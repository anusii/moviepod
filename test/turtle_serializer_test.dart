/// Tests for the TurtleSerializer class.
///
...
void main() {
  group('TurtleSerializer', () {
    ...
    test('should serialize and deserialize ratings correctly', () {
      final ratings = {'12345': 8.5, '67890': 7.2, '11111': 9.0};
      ...
      debugPrint('Generated Ratings TTL:');
      debugPrint(ttl);
    ...
    test('should serialize and deserialize comments correctly', () {
      ...
      debugPrint('Generated Comments TTL:');
      debugPrint(ttl);
    ...
    test(
      'should handle special characters in movie titles and descriptions',
      () {
        final movie = Movie(
          id: 99999,
        ...
        final ttl = TurtleSerializer.moviesToTurtleWithJson(
          movies,
          'specialCharsTest',
        );
        ...
        expect(deserializedMovies.length, 1);
        expect(
          deserializedMovies.first.title,
          'Movie with "Quotes" & Special Characters',
        );
        expect(
          deserializedMovies.first.overview,
          'Description with\nnewlines and\ttabs and "quotes"',
        );
      },
    );
